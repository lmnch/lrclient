...
import {  LRCConfig, loadEndpoint, loadEnvironment, loadPayload, storePayload, ConfigManager, storeEndpoint } from './config';
...
export { LRClient, LRCListener, LRCConstants, 
    ...
    LRCConfig, loadEndpoint, storeEndpoint, loadEnvironment, loadPayload, storePayload, ConfigManager,
